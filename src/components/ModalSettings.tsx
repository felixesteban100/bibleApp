...
function ModalSettings({ textSize, changeTextSize, fontFamily, changeFontFamily, history, changeBookandChapter, theme, setTheme }: ModalSettingsProps) {
